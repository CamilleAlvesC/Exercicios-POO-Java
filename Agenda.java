...
public class Agenda {
    ...
    public static void main(String[] args) {
        ...
        minhaAgenda.adicionarContato("Camille", "11465432");
        minhaAgenda.adicionarContato("Evanderson", "11654321");
        minhaAgenda.adicionarContato("Hernanderson", "987654321");

        minhaAgenda.exibirContatos();

        minhaAgenda.removerContato("Evanderson");
